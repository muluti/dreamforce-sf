...
export const EmergencySosModal: React.FC<EmergencySosModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-end md:items-center justify-center bg-black/60 backdrop-blur-[8px] p-0 md:p-4 animate-in fade-in duration-200">
      <div className="w-full max-w-xl max-h-[90dvh] flex flex-col rounded-t-[28px] md:rounded-[28px] border-2 border-rose-300 dark:border-rose-800 bg-[var(--color-surface)] shadow-2xl overflow-hidden animate-in slide-in-from-bottom duration-300">
        {/* 드래그 핸들 */}
